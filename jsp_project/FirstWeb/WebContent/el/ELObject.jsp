...
<body>
	...
	성인 여부 판단 = ${member.age-1 > 18} / ${member.age-1 gt 19} / ${member.name eq '손흥민'} / ${member.name eq '이강인' && member.age > 15} / ${member.age-1 > 19 ? '성인' : '미성년'} / ${not empty list} <br>
	
	
	<hr>
	
	배열 요소 출력 : ${arr[0]} / ${arr[1]} / ${arr[2]} <br>
	List 요소 출력 : ${list[0]} / ${list[1]} / ${list[2]} / ${list[3]} <br>
	Map 요소 출력 : ${player.name} / ${player.team} / ${player.no} <br>
	일반 객체인 경우 메소드 호출 : <br>

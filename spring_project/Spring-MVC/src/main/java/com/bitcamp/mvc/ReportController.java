...
public class ReportController {
	...
	@PostMapping("/submit3")
	public String submit3(@ModelAttribute("report") ReqReport report, HttpServletRequest request) {
	...
	public String submit1(@RequestParam("sno") String sno, @RequestParam("sname") String sname, @RequestParam("report") MultipartFile report, Model model, HttpServletRequest request) {
		...
		String newFileName = sno+"."+report.getOriginalFilename();
